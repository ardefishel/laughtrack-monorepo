export const idTranslations = {
    account: {
        ...
        deleteAccountConfirmMessage: 'Ini akan menghapus akun Anda secara permanen beserta semua data termasuk catatan, bit, premis, dan setlist. Tindakan ini tidak dapat dibatalkan.',
        deleteAccountConfirmTitle: 'Hapus Akun Anda?',
        deleteAccountDescription: 'Hapus akun dan semua data secara permanen',
        deleteAccountFailed: 'Penghapusan Akun Gagal',
        deleteAccountSuccess: 'Akun Dihapus',
        deleteAccountSuccessMessage: 'Akun Anda dan semua data terkait telah dihapus secara permanen.',
        deleteAccountTypeConfirm: 'Ketik HAPUS untuk konfirmasi',
        deleting: 'Menghapus...',
