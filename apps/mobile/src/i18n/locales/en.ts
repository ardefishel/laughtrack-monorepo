export const enTranslations = {
    account: {
        ...
        deleteAccountConfirmMessage: 'This will permanently delete your account and all your data including notes, bits, premises, and setlists. This action cannot be undone.',
